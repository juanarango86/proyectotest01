    ...
    <div class="card-body">
        ...
        <form class="needs-validation" novalidate>
            <div class="form-row">
                <div class="col-md-6">
                    <div class="position-relative form-group">
                        ...
                        <input type="text" class="form-control" id="validationCustom01" placeholder="Nombre Proyecto"
                            value="" required>
                    </div>
            ...
            <div class="col-md-13 mb-4">
                ...
                <textarea name="text" id="exampleText" class="form-control" id="validationCustom02"
                    placeholder="Descripcion / Resumen del proyecto" value="Otto" required></textarea>
                <div class="valid-feedback">
                    Correcto!
                </div>
            </div>
